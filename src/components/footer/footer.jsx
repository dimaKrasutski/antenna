...
export const Footer = ({ className }) => (
  ...
  <p className="mb-0">
   ...
   УНП 192958129,
    ...
    <a className="text-xs-small" href="https://antenna-tv.tech/politics.html" target="_blank" rel="noopener noreferrer">
      Политика конфиденциальности
    </a>
   
    <p className="mb-0" />
    <a className="text-xs-small" href="https://antenna-tv.tech/agreement.html" target="_blank" rel="noopener noreferrer">
      Пользовательское соглашение
    </a>

    <p className="mb-0" />
    <a className="text-xs-small pb-2" href="https://antenna-tv.tech/dogovor_vozvrata.html" target="_blank" rel="noopener noreferrer">
